...
<span class="icon bar"></span>
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="clienthome">BBstore</a>
    </div>
...
<ul class="nav navbar-nav">
 ...
 <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Products Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="fruitveges ">Fruits and Veges</a></li>
          <li><a href="homecare"> Home Care</a></li>
          <li><a href="organicrange">Organic range</a></li> 
