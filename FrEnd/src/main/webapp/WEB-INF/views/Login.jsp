...
<div class="row">
  ...
  <a href="user"> <button type="button" class="btn btn-lg btn">Create Account</button></a>
	<a href="ClientHome" action="perform_login"> </a><button type="submit" class="btn btn-lg btn">Submit</button>	    
